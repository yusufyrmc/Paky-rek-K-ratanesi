...
-- İş günü 01:50'de değiştiği için ödeme kaydına iş günü tarihi eklenir.
ALTER TABLE payments
  ADD COLUMN IF NOT EXISTS business_date DATE
  DEFAULT (((CURRENT_TIMESTAMP AT TIME ZONE 'Europe/Istanbul') - INTERVAL '1 hour 50 minutes')::date);

UPDATE payments
SET business_date = ((created_at AT TIME ZONE 'Europe/Istanbul') - INTERVAL '1 hour 50 minutes')::date
